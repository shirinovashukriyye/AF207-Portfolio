  ...
  async function createUserCard() {
    ...
    try {
      ...
      data.forEach(product => {
        ...
        let isInWishlist = isLoginedUser?.wishlist?.some(item => item.id === product.id) || false;
        ...
        img.src = product.image || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRv1ank-wR_C1doFKGVu5XKmO5bg6RTaVub5A&s";
        ...
        cardCategory.textContent = product.category || "No Category";
        ...
        cardPrice.textContent = product.price ? `$${product.price}` : "$0.00";
        ...
        cardReviewsCount.textContent = product.rating?.count || "0";
        ...
        card.append(heartIcon, cardImage, cardContent, cardButton);
